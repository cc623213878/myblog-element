    ...
    <el-container class="middle">
      <el-aside class="sider" width="200px">
        <el-collapse v-model="activeNames">
          ...
          <el-collapse-item title="友情链接" name="3" class="friend"></el-collapse-item>
      ...
      <el-container>
        <el-main
          style="padding: 0"
          class="main-body-view"
          id="scroll-view"
          v-on:scroll.native="setViewPoint"
        >
          <div id="mainBody">
...
export default {
    ...
    window.onresize = () => {
      return (() => {
        ...
        this.scrollBarHeight =
          (document.body.clientHeight - 181).toString() + "px";
      })();
    };
  },
  mounted: function() {
  ...
  watch: {
    viewPoint: function() {
      document.getElementById("scroll-view").scrollTop =
        (this.scrollviewhideHeight - this.viewPoint) / this.scrollmultiple;
    },
  ...
  methods: {
    scrollBarChange() {
      ...
      this.scrollviewhideHeight =
        this.mainBodyHeight - (document.body.clientHeight - 61);
    ...
    setViewPoint() {
      this.viewPoint =
        this.scrollviewhideHeight -
        document.getElementById("scroll-view").scrollTop * this.scrollmultiple;
    }
  }
};
</script>
